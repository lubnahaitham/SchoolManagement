...
from apps.corecode.models import AcademicSession, AcademicTerm, AcademicYear, StudentClass
...
class Invoice(models.Model):
    ...
    unifrom = models.CharField(max_length=255, null=True, blank=True)
    balance_uniform = models.IntegerField(null=True, blank=True)
    books = models.CharField(max_length=255, null=True, blank=True)
    balance_books = models.IntegerField(null=True, blank=True)
