# Generated by Django 3.2.2 on 2022-08-27 12:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unifrom', models.CharField(blank=True, max_length=255, null=True)),
                ('balance_uniform', models.IntegerField(blank=True, null=True)),
                ('books', models.CharField(blank=True, max_length=255, null=True)),
                ('balance_books', models.IntegerField(blank=True, null=True)),
